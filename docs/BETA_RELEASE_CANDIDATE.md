...
Phase 7C maps synthetic corridor-specific KYC/KYB, AML, sanctions,
transaction-monitoring, travel-rule and audit requirements. It collects no
identity or document data and cannot screen, clear or create a compliance case.
Phase 7D adds a synthetic sandbox transfer lifecycle with idempotency, signed
...
Phase 8A adds a venue-qualified global instrument reference, explicit calendar
...
Phase 8F adds a global event impact workspace with a governed source registry,
explicit country coverage, country/commodity/currency/logistics graph links,
probabilistic causal scenarios and private in-app alerts. The initial events are
...
Phase 8I adds 195 sovereign reference identities, eight consistent intelligence
domains, 1,560 explicit evidence gaps and seven human-governed release gates.
...
Phase 8M adds eight provider-neutral contract-suite specifications, ten
fail-closed conformance assertions and twenty-four deterministic synthetic
...
- Evidence-first market, trade and global-equity research with venue-qualified listing identities and explicit data states.
...
- A private grounded agent workspace with customizable analysis, reusable
  ...
  candidates.
- A source-authenticity-gated global event workspace with explicit country
  coverage, causal impact paths and private in-app alert policies.
