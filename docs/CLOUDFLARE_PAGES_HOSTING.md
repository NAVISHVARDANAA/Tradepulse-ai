...
1. Open **Actions → Build production web release**, choose `main`, enter
   `BUILD_PHASE_5I` and record the green beta-hardening web artifact.
2. Open **Actions → Deploy controlled beta web**, choose `main`, enter
   `DEPLOY_PHASE_5I` and approve the protected production environment.
...
4. After a release or operational incident, open **Actions → Verify web
   production**, choose `main`, enter `VERIFY_WEB_PHASE_5I` and retain the green
...
Migration 035 remains the latest verified data boundary. Phase 5I adds no database
migration or Edge Function and does not activate any cohort or external invitation.
