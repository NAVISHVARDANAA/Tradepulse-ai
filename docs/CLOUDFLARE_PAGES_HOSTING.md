...
1. Open **Actions → Build production web release**, choose `main`, enter
   `BUILD_PHASE_5D` and record the green invite-only beta artifact.
2. Open **Actions → Deploy controlled beta web**, choose `main`, enter
   `DEPLOY_PHASE_5D` and approve the protected production environment.
...
4. After a release or operational incident, open **Actions → Verify web
   production**, choose `main`, enter `VERIFY_WEB_PHASE_5D` and retain the green
