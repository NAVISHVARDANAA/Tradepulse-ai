...
1. Open **Actions → Build production web release**, choose `main`, enter
   `BUILD_PHASE_5H` and record the green approved-pilot web artifact.
2. Open **Actions → Deploy controlled beta web**, choose `main`, enter
   `DEPLOY_PHASE_5H` and approve the protected production environment.
...
4. After a release or operational incident, open **Actions → Verify web
   production**, choose `main`, enter `VERIFY_WEB_PHASE_5H` and retain the green
...
Deploy and verify migration 035 before this web release. Phase 5H adds no Edge
Function and does not activate any cohort or external invitation.
