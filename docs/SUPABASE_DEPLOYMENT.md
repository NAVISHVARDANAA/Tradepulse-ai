...
4. Enter `DEPLOY_PHASE_4P` as the confirmation value.
...
migration `030`, checks active functions, runs the query-only production lock
...
operational incident. Select `main` and enter `VERIFY_PHASE_4P`.
