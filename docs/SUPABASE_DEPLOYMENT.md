...
4. Enter `DEPLOY_PHASE_4N` as the confirmation value.
...
migration `026`, checks active functions, runs the query-only production lock
...
operational incident. Select `main` and enter `VERIFY_PHASE_4N`.
