...
for (const [workflow, confirmation] of [
  ...
  [buildWeb, 'BUILD_PHASE_8C'], [deployWeb, 'DEPLOY_PHASE_8C'],
...
for (const guideText of [releaseGuide, hostingGuide, supabaseGuide]) assert(guideText.includes('PHASE_8C'), 'A current release guide omits Phase 8A')
