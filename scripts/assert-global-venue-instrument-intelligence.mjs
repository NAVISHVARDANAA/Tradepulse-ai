...
assert(verifyData.includes('migration 049'), 'Data verification omits the current migration parity check')
...
for (const guideText of [releaseGuide, hostingGuide, supabaseGuide]) assert(guideText.includes('PHASE_8E'), 'A current release guide omits Phase 8D')
