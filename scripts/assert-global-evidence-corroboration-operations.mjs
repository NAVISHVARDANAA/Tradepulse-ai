...
assert(manifest.phase === '8H' && manifest.status === 'global_evidence_corroboration_candidate', 'Manifest is not Phase 8H')
...
for (const [workflow, token] of [[deployData, 'DEPLOY_DATA_PHASE_8H'],
  [verifyData, 'VERIFY_DATA_PHASE_8H'], [buildWeb, 'BUILD_PHASE_8H'],
  [deployWeb, 'DEPLOY_PHASE_8H'], [verifyWeb, 'VERIFY_WEB_PHASE_8H']]) {
