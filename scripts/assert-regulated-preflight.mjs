...
assert(manifest.phase === '6A', 'Release manifest is not Phase 6A')
...
for (const [workflow, contract] of [
  [deployData, 'DEPLOY_DATA_PHASE_6A'],
  [verifyData, 'VERIFY_DATA_PHASE_6A'],
  [buildWeb, 'BUILD_PHASE_6A'],
  [deployWeb, 'DEPLOY_PHASE_6A'],
  [verifyWeb, 'VERIFY_WEB_PHASE_6A'],
