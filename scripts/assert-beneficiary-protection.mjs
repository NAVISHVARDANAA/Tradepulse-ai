...
assert(manifest.status === 'global_provider_certification_isolated_intake_candidate', 'Release status is not the global venue and instrument intelligence candidate')
