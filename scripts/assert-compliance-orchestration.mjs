...
assert(manifest.status === 'global_provider_candidate_evidence_review_candidate', 'Release status is not the global venue and instrument intelligence candidate')
