...
assert(manifest.status === 'global_observation_provenance_quarantine_candidate', 'Release status is not the global venue and instrument intelligence candidate')
