...
assert(manifest.phase === '8F', 'Release manifest is not Phase 8F')
assert(manifest.status === 'global_event_intelligence_candidate', 'Release status is not the Phase 8F candidate')
