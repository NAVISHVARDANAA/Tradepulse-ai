...
assert(manifest.phase === '8N', 'Release manifest is not Phase 8F')
assert(manifest.status === 'global_provider_candidate_evidence_review_candidate', 'Release status is not the Phase 8F candidate')
