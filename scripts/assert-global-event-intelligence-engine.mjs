...
assert(manifest.phase === '8J', 'Release manifest is not Phase 8F')
assert(manifest.status === 'global_dependency_transmission_candidate', 'Release status is not the Phase 8F candidate')
