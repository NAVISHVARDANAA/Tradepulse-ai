...
assert(manifest.phase === '8K', 'Release manifest is not Phase 8F')
assert(manifest.status === 'global_observation_provenance_quarantine_candidate', 'Release status is not the Phase 8F candidate')
