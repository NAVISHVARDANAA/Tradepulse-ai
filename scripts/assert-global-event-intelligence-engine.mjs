...
assert(manifest.phase === '8M', 'Release manifest is not Phase 8F')
assert(manifest.status === 'global_provider_contract_test_lab_candidate', 'Release status is not the Phase 8F candidate')
