...
assert(manifest.phase === '8G', 'Release manifest is not Phase 8F')
assert(manifest.status === 'controlled_live_rollout_candidate', 'Release status is not the Phase 8F candidate')
