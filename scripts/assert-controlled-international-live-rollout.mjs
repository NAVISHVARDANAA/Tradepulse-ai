...
assert(manifest.phase==='8I'&&manifest.status==='global_country_coverage_candidate','Manifest is not Phase 8G')
...
for(const [workflow,token] of [[deployData,'DEPLOY_DATA_PHASE_8I'],[verifyData,'VERIFY_DATA_PHASE_8I'],[buildWeb,'BUILD_PHASE_8I'],[deployWeb,'DEPLOY_PHASE_8I'],[verifyWeb,'VERIFY_WEB_PHASE_8I']]) assert(workflow.includes(token),`Workflow omits ${token}`)
