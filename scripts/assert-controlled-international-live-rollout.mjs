...
assert(manifest.phase==='8N'&&manifest.status==='global_provider_candidate_evidence_review_candidate','Manifest is not Phase 8G')
...
for(const [workflow,token] of [[deployData,'DEPLOY_DATA_PHASE_8N'],[verifyData,'VERIFY_DATA_PHASE_8N'],[buildWeb,'BUILD_PHASE_8N'],[deployWeb,'DEPLOY_PHASE_8N'],[verifyWeb,'VERIFY_WEB_PHASE_8N']]) assert(workflow.includes(token),`Workflow omits ${token}`)
