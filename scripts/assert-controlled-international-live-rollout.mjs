...
assert(manifest.phase==='8L'&&manifest.status==='global_provider_certification_isolated_intake_candidate','Manifest is not Phase 8G')
...
for(const [workflow,token] of [[deployData,'DEPLOY_DATA_PHASE_8L'],[verifyData,'VERIFY_DATA_PHASE_8L'],[buildWeb,'BUILD_PHASE_8L'],[deployWeb,'DEPLOY_PHASE_8L'],[verifyWeb,'VERIFY_WEB_PHASE_8L']]) assert(workflow.includes(token),`Workflow omits ${token}`)
