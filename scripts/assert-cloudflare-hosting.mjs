...
for (const contract of ['VERIFY_WEB_PHASE_8H', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8H', 'Hosting candidate is not on Phase 8D')
assert(manifest.status === 'global_evidence_corroboration_candidate', 'Hosting status changed unexpectedly')
