...
for (const contract of ['VERIFY_WEB_PHASE_6C', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '6C', 'Hosting candidate is not on Phase 6C')
assert(manifest.status === 'live_trading_readiness_candidate', 'Hosting status changed unexpectedly')
