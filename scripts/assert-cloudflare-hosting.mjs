...
for (const contract of ['VERIFY_WEB_PHASE_8B', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8B', 'Hosting candidate is not on Phase 8B')
assert(manifest.status === 'international_multi_asset_paper_trading_candidate', 'Hosting status changed unexpectedly')
