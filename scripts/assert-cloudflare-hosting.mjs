...
for (const contract of ['VERIFY_WEB_PHASE_7A', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '7A', 'Hosting candidate is not on Phase 7A')
assert(manifest.status === 'corridor_intelligence_candidate', 'Hosting status changed unexpectedly')
