...
for (const contract of ['VERIFY_WEB_PHASE_8N', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8N', 'Hosting candidate is not on Phase 8L')
assert(manifest.status === 'global_provider_candidate_evidence_review_candidate', 'Hosting status changed unexpectedly')
