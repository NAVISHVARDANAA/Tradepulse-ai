...
for (const contract of ['VERIFY_WEB_PHASE_8A', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8A', 'Hosting candidate is not on Phase 8A')
assert(manifest.status === 'global_venue_instrument_intelligence_candidate', 'Hosting status changed unexpectedly')
