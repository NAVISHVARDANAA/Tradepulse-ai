...
for (const contract of ['VERIFY_WEB_PHASE_8I', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8I', 'Hosting candidate is not on Phase 8I')
assert(manifest.status === 'global_country_coverage_candidate', 'Hosting status changed unexpectedly')
