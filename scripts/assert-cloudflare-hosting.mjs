...
for (const contract of ['VERIFY_WEB_PHASE_7D', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '7D', 'Hosting candidate is not on Phase 7D')
assert(manifest.status === 'sandbox_transfer_lifecycle_candidate', 'Hosting status changed unexpectedly')
