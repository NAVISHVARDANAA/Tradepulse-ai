...
for (const contract of ['VERIFY_WEB_PHASE_8M', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8M', 'Hosting candidate is not on Phase 8L')
assert(manifest.status === 'global_provider_contract_test_lab_candidate', 'Hosting status changed unexpectedly')
