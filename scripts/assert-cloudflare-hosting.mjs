...
for (const contract of ['VERIFY_WEB_PHASE_8J', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8J', 'Hosting candidate is not on Phase 8J')
assert(manifest.status === 'global_dependency_transmission_candidate', 'Hosting status changed unexpectedly')
