...
for (const contract of ['VERIFY_WEB_PHASE_7E', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '7E', 'Hosting candidate is not on Phase 7E')
assert(manifest.status === 'controlled_money_movement_readiness_candidate', 'Hosting status changed unexpectedly')
