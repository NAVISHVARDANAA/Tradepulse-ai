...
for (const contract of ['VERIFY_WEB_PHASE_6B', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '6B', 'Hosting candidate is not on Phase 6B')
assert(manifest.status === 'sandbox_order_lifecycle_candidate', 'Hosting status changed unexpectedly')
