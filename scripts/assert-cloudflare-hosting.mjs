...
for (const contract of ['VERIFY_WEB_PHASE_8E', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8E', 'Hosting candidate is not on Phase 8D')
assert(manifest.status === 'agentic_investing_candidate', 'Hosting status changed unexpectedly')
