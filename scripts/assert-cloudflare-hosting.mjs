...
for (const contract of ['VERIFY_WEB_PHASE_8G', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8G', 'Hosting candidate is not on Phase 8D')
assert(manifest.status === 'controlled_live_rollout_candidate', 'Hosting status changed unexpectedly')
