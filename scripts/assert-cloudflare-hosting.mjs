...
for (const contract of ['VERIFY_WEB_PHASE_8F', 'environment: production', 'npm run test:e2e:production']) {
...
assert(manifest.phase === '8F', 'Hosting candidate is not on Phase 8D')
assert(manifest.status === 'global_event_intelligence_candidate', 'Hosting status changed unexpectedly')
