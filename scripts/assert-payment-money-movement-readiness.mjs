...
assert(verifyData.includes('migration 050'), 'Current data verification does not prove parity through migration 050')
...
for (const guideText of [releaseGuide, hostingGuide, supabaseGuide]) {
  assert(guideText.includes('PHASE_8F'), 'A current release guide omits Phase 8D confirmations')
}
